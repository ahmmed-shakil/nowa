...
import {
  ...
  getInitialValues,
} from "../../../../formConfigs/storeSKU/Category/formConfigs";

const tableData = [
  {
    id: 1,
    SKUCategoryName: "Category AB3",
    approvalStatus: true,
    createdBy: "user1",
    approvedBy: "userA",
    updatedBy: "user1A",
...
const tableColumns = [
  { field: "SKUCategoryName", label: "Name" },
