...
import {Basicdata,Business,Monthdata} from "../../../shared/data/pages/pricing"
          ...
          >
            ...
            <Card.Body className="pt-2 pb-0">
              <ul className="text-justify pricing-body text-muted ps-0 mb-4">
                  ...
                  <label className={playerData.className}>
                    <span className="check-box mb-0">
                      <span className="ckbox">
                        <input
                          defaultChecked={playerData.check}
                          type="checkbox"
                        />
                        <span></span>
                      </span>
                ...
                <li className="mb-1">
                  <label className="d-flex align-items-center p-2 br-5 border text-truncate">
                    <span className="check-box mb-0">
                      <span className="ckbox">
                        <input
                          defaultChecked={playerData.check}
                    ...
                    <span className="ms-3 tx-12 my-auto">
                      Daily Updates
                      <span className="tx-10 rounded-pill lh-1 badge badge-light-transparent text-dark font-weight-semibold ms-2">
                        Unlimited
                      </span>
                    </span>
                    <strong className="ms-auto text-dark tx-12">$100</strong>
                  </label>
                </li>
                <li className="mb-1">
                  <label className="d-flex align-items-center p-2 br-5 border text-truncate">
                    ...
                    <strong className="ms-auto text-dark tx-12">Free</strong>
                  </label>
                </li>
                <li className="mb-1">
                  <label className={playerData.className}>
                    <span className="check-box mb-0">
                      <span className="ckbox">
                        <input
                          defaultChecked={playerData.checks}
                          type="checkbox"
                        />
                        <span></span>
                      </span>
                ...
                <li className="mb-1">
                  <label className="d-flex align-items-center p-2 br-5 border text-truncate">
                    <span className="check-box mb-0">
                      <span className="ckbox">
                        <input
                          defaultChecked={playerData.checkemail}
                          type="checkbox"
                        />
                        <span></span>
                      </span>
                    ...
                    <strong className="ms-auto text-dark tx-12">$154</strong>
                  </label>
                </li>
                <li className="mb-1">
                  <label className="d-flex align-items-center p-2 br-5 border text-truncate">
