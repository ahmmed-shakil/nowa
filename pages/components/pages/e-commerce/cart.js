...
import {Datacard} from '../../../../shared/data/pages/e-commerce/cart'
import { Delete, REMOVE, ADD } from '../../../../shared/redux/actions/action';
      ...
      <tbody>
            ...
            <Card.Footer>
              <div className="shopping-cart-footer bd-0">
                <div className="column">
                  <Link className="btn btn-secondary" href={`/components/pages/e-commerce/shop/`}>
                    <i className="fe fe-corner-up-left  mx-2"></i>Back to Shopping
                  </Link>
                </div>
                <div className="column">
                  <Link className="btn btn-primary" href={`/components/pages/e-commerce/cart/`}>
                    <i className="fe fe-refresh-cw mx-2"></i>Update Cart
                  </Link>
                  <Link className="btn btn-outline-primary" href={`/components/pages/e-commerce/checkout/`}>
        ...
        <Col lg={12} xl={3} md={12}>
          ...
          <Card className="custom-card cart-details">
            ...
            <Card.Footer>
              <div className="column">
                <Link className="btn btn-primary" href={`/components/pages/e-commerce/shop/`}>
                  Continue Shopping
                </Link>
              </div>
            </Card.Footer>
