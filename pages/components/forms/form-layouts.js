...
import { Optioncategory1, OptionYear } from "../../../shared/data/form/form-layouts"
                      ...
                      <FormGroup className="form-group mg-b-25">
                        <Form.Label className="ckbox mg-b-5">
                          ...
                          <span className="tx-13">
                            I agree to <Link href="#!">Terms</Link> and{" "}
              ...
              <Dropdown className="main-dropdown-form-demo">
                <div className="mg-t-20">
                  ...
                  <Dropdown.Menu className="dropdown-menu">
                    <h6 className="dropdown-title text-start">Subscribe</h6>
