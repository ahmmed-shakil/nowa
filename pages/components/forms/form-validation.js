...
import { optionselectyear,optionCustom,objectArraysingle,optionTooltips,optiondefault} from "../../../shared/data/form/form-validation"
import {
  CForm,
  CCol,
  CFormLabel,
...
const FormValidation = () =>{
  ...
  return (
    ...
    >
      ...
      <CCol md={4} className="position-relative">
        <CFormLabel htmlFor="validationTooltip02">Full Name</CFormLabel>
        <CFormInput
          type="text"
      ...
      <CCol md={3} className="position-relative">
        <CFormLabel htmlFor="validationTooltip05">Zip Code</CFormLabel>
