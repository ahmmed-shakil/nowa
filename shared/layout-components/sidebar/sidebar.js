...
const Sidebar = () => {
  ...
  const [initialMenuitems, setInitialMenuitems] = useState(MENUITEMS);
  ...
  //       const profileData = await dispatch(fetchUserProfile({ email, type }));
  //       console.log("🚀 ~ fetchProfile ~ profileData:", profileData);
  //       const response = await profileData?.payload?.data;
  //       console.log("🚀 ~ fetchProfile ~ response:", response);
  //       session.type === "admin"
  //         ? setPermissions(response?.admin_roles?.admin_permissions)
  //         : setPermissions(response?.restaurant_roles?.restaurant_permissions);
  //     } catch (error) {
  ...
  //     const filteredMenuItems = initialMenuitems.filter((mainItems) => {
  //       if (mainItems?.Items) {
  //         mainItems.Items = mainItems.Items.filter((subItem) => {
  //           if (subItem?.children) {
  //             subItem.children = subItem.children.filter((child) => {
  //               if (child?.children) {
  ...
  //         });
  //       }
  //       if (mainItems.Items && !mainItems?.Items?.length) {
  //         return false;
  //       }
  //       return mainItems;
  //     });
