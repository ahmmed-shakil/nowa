...
export function getInitialValues(data) {
  if (data) {
    ...
    let rrType = data.restaurantRoleName;
  ...
  return [
    ...
    },
    {
      ...
      fields: [
        ...
        {
          label: "Restaurant Role Name",
          type: "text",
          placeholder: "Restaurant Role Name",
          required: true,
          defaultValue: initialData?.restaurantRoleName,
        },
        {
          // <input
          type: "file",
